...
## Homework 3 problem files

The HW3 coding problems are in:

- `homeworks/intro_pytorch/`
- `homeworks/kernel_bootstrap/`
- `homeworks/neural_network_mnist/`
- `homeworks/multinomial_log_regression.py`

See the corresponding README files in `homeworks/` and the HW3 PDF for the full
problem statements.
